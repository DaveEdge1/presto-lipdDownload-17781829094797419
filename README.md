...
**Reconstruction ID:** 17781829094797419
...
- **Compilation:** Pages2k,CoralHydro2k-1_0_0,iso2k-1_1_2
- **Extends back to:** ≥ 100 yr BP

**Selected records:** 898 TSIDs

See [`query_params.json`](query_params.json) for the full query specification and TSID list.

## Data Cleaning

117 duplicate group(s) were reviewed and **132 record(s) removed**.
